...
namespace LuminousFluxOrb
{
    ...
    public class DiamondsController : MonoBehaviour
    {
        ...
        [Header("Diamond Size")]
        [Range(1f, 100f)]
        public float minDiamondSize = 5f;

        [Range(1f, 100f)]
        public float maxDiamondSize = 10f;
        ...
        private void InitData()
        {
            ...
            // 새로운 크기 설정 방식
            float minRadius = minDiamondSize;
            float maxRadius = maxDiamondSize;
            ...
            for (int i = 0; i < total; i++)
            {
                Diomonds d = new Diomonds
                {
                    ...
                    scale = (Random.value * radiusRange + minRadius) * overallScale
                };
                diomondsData[i] = d;
            }
        }
        ...
        private void OnValidate()
        {
            ...
            if (minDiamondSize > maxDiamondSize)
            {
                maxDiamondSize = minDiamondSize;
            }
